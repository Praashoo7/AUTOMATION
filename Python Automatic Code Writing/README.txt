...
OG_imgs_data.txt :- This file has Dictionary of all file-Keys and file-names which are laready present in the drive. Using this we can identify newly added files.
                    We also write data back in this file as we aquire information about newly added files for further use.
comp_count.txt :- This file has a counter which increases by one after every image added. Using which we can give accurate numbers to the images on the webpage.
pfile_data.txt :- Information related to images are stored in this file, Script reads information of images and the image name from this file and creates dictionary with                   name and information.
