...
(In this we don't need comp_count.txt because we don't have extra pair of images so we can count the number using counter inside the code, we don't need a txt for that. 4 files instead of 5 Everything else is same as above.)
