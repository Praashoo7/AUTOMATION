...
2. In mailSendDAN.py, The script is scheduled to run at "00:00" every day and it sends Happy Birthday and PARTICULAR PERSOSN'S NAME as message and Total Years, Months, Weeks and Days They have lived till Date WRITTEN IN A TEXT FILE ATTACHED in the mail on the person's E-MailId who evers birthday is on that day.(This looks like a huge code because instead of using implicit libraries i used the function i created my self for date calculations. It can be simply reduced.)
