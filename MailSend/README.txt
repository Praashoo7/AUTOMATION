...
3. In Third Code mailSendDA.py, The script is scheduled to run at "00:00" every day and it sends Happy Birthday as message and Total Years, Months, Weeks and Days They have lived till Date written in a text file attached in the mail on the person's E-MailId who evers birthday is on that day.

This Calculates any give Person's Total Years/Months/Wweeks/Days from the given excel file and sends to Only that Particular Person.
